...
const operations: Operation[] = [
  ...
  {
    name: "Update a badge",
    endpoint: "/api/badges/:badgeId",
    method: "PATCH",
    fields: {badgeId: "input", updates: "json"},
  },
  {
    name: "Delete a badge",
    endpoint: "/api/badges/:badgeId",
    method: "DELETE",
    fields: {badgeId: "input"},
  },
  {
    name: "Add points to badge for user (body has points: number in json format)",
    endpoint: "/api/user/:userId/badges/:badgeId",
    method: "POST",
    fields: {userId: "input", badgeId: "input", pointsToAdd: "json"},
  },
  {
    name: "**need to fix after posting is implemented** Add points to respective badge for user BY HASHTAGS",
    endpoint: "/api/user/:userId/hashtags",
    method: "POST",
    fields: {userId: "input", hashtags: "json"},
  },
  {
    name: "Get badges that user has started",
